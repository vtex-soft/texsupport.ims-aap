...
%%  (see 'Affiliations')                    %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author{\fnms{First} \snm{Author}\thanksref{m1,t1,t2}
\ead[label=e1]{first@somewhere.com}},
\author{\fnms{Second} \snm{Author}\thanksref{m1,m2,t3}
\ead[label=e2]{second@somewhere.com}}
\and
\author{\fnms{Third} \snm{Author}\thanksref{m2,t1}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\affiliation{Some University\thanksmark{m1}
and Another University\thanksmark{m2}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                Addresses                 %%
...
City, Full US State Name and Zip Code\\
Country\\
\printead{e1}\\
...
\thankstext{t2}{Supported in part by NSF Grant DMS-??-?????.}
\thankstext{t3}{Supported by second supporter of the project.}
...
\item
This is the second item of the list.  It contains another
list nested inside it.  The two inner lists are an \emph{enumerated}
list.
\begin{enumerate}
\item
...
\begin{fact}%Edgarai, Siga, reikia perklausti Patriko del to ar fact IMS bus italic ar roman. (K.V.)
...
\hline
\textbf{Equil.} \\
\textbf{points} & \multicolumn{1}{c}{$\boldsymbol{x}$}
& \multicolumn{1}{c}{$\boldsymbol{y}$} & \multicolumn{1}{c}{$\boldsymbol{z}$}
& \multicolumn{1}{c}{$\boldsymbol{C}$} & \textbf{S} \\
\hline
...
\begin{eqnarray}
 \mu_{\text{normal}} & = & \mu_{x} \frac{C_{s}}{K_{x}C_{x}+C_{s}}  \nonumber\\
                     & = & \mu_{\text{normal}} - Y_{x/s}(1-H(C_{s}))(m_{s}+\pi /Y_{p/s}) \nonumber\\
